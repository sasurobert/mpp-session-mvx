...
fn test_full_session_lifecycle() {
    ...
    let channel_id = multiversx_sc_scenario::multiversx_chain_vm::crypto_functions::keccak256(&channel_id_msg);
    ...
    world.check_state_step(
        CheckStateStep::new()
            ...
            .put_account(&employer_address, CheckAccount::new().balance("5000000000000000000"))
    );
    ...
    let final_hash = multiversx_sc_scenario::multiversx_chain_vm::crypto_functions::keccak256(&final_msg);
    ...
    world.check_state_step(
        CheckStateStep::new()
            ...
            .put_account(&employer_address, CheckAccount::new().balance("9999999999980000000"))
    );
}
